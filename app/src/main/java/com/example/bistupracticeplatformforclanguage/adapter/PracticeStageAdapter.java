...
public class PracticeStageAdapter extends RecyclerView.Adapter<PracticeStageAdapter.ViewHolder>
{
    private List<Stage> list;
    private PreparePracticeActivity activity;

    public PracticeStageAdapter(List<String> nameList, PreparePracticeActivity activity)
    {
        list = new ArrayList<>();
    ...
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_practice_stage, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position)
    {
        ...
        holder.text_stage.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = intent = new Intent(activity, PracticeActivity.class);
